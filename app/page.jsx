...
const demoPosts = [
  { id: 1, platforms: ["instagram", "tiktok"], type: "Reel", title: "Energievertrieb 2026 – So startest du durch", date: "2026-02-03", views: 12400, likes: 890, comments: 124, shares: 67, done: true, status: "published", postUrls: { instagram: "https://www.instagram.com/mitunsverkaufen/", tiktok: "https://www.tiktok.com/@mitunsverkaufen" } },
  { id: 2, platforms: ["instagram", "tiktok"], type: "Video", title: "Door-to-Door Sales: 5 Tipps vom Profi", date: "2026-02-05", views: 34200, likes: 2100, comments: 310, shares: 445, done: true, status: "published", postUrls: { instagram: "https://www.instagram.com/mitunsverkaufen/", tiktok: "https://www.tiktok.com/@mitunsverkaufen" } },
  { id: 3, platforms: ["instagram", "tiktok"], type: "Karussell", title: "Partnermodell erklärt – Passives Einkommen", date: "2026-02-08", views: 8900, likes: 620, comments: 89, shares: 34, done: true, status: "published", postUrls: { instagram: "https://www.instagram.com/mitunsverkaufen/", tiktok: "https://www.tiktok.com/@mitunsverkaufen" } },
  { id: 4, platforms: ["instagram", "tiktok"], type: "Video", title: "Tag im Leben eines Energieberaters", date: "2026-02-10", views: 51000, likes: 3400, comments: 520, shares: 780, done: false, status: "published", postUrls: { instagram: "https://www.instagram.com/mitunsverkaufen/", tiktok: "https://www.tiktok.com/@mitunsverkaufen" } },
  { id: 5, platforms: ["instagram", "tiktok"], type: "Reel", title: "Stadtwerke Krefeld – Behind the Scenes", date: "2026-02-12", views: 6200, likes: 410, comments: 56, shares: 23, done: false, status: "published", postUrls: { instagram: "https://www.instagram.com/mitunsverkaufen/", tiktok: "https://www.tiktok.com/@mitunsverkaufen" } },
  { id: 6, platforms: ["instagram", "tiktok"], type: "Story", title: "Q&A: Häufigste Fragen zu unserem Netzwerk", date: "2026-02-14T18:00:00", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "scheduled", timezone: "CET", createdAt: "2026-02-10", createdBy: "Dariel" },
  { id: 7, platforms: ["instagram", "tiktok"], type: "Video", title: "Vorher/Nachher: Agentur-Transformation", date: "2026-02-17T12:30:00", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "scheduled", timezone: "CET", createdAt: "2026-02-12", createdBy: "Dariel" },
  { id: 8, platforms: ["instagram"], type: "Reel", title: "Warum Stadtwerke Krefeld? Die Vorteile", date: "2026-02-19", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "draft" },
  { id: 9, platforms: ["tiktok"], type: "Video", title: "Recruiting-Strategie für Agenturen", date: "2026-02-21", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "draft" },
  { id: 10, platforms: ["instagram", "tiktok"], type: "Karussell", title: "5 Gründe für mitunsverkaufen.de", date: "2026-02-24", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "draft" },
  { id: 11, platforms: ["instagram", "tiktok"], type: "Video", title: "Live-Coaching: Einwandbehandlung", date: "2026-02-26", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "draft" },
  { id: 12, platforms: ["instagram", "tiktok"], type: "Reel", title: "Monatsrückblick Februar", date: "2026-02-28", views: 0, likes: 0, comments: 0, shares: 0, done: false, status: "draft" },
];
          ...
          {filtered.map((post) => {
            ...
            return (
              <div key={post.id} onClick={() => toggle(post.id)} style={{ display: "flex", alignItems: "center", gap: 16, padding: "12px 20px", borderRadius: 12, background: C.card, border: `1px solid ${C.border}`, cursor: "pointer", transition: "all 0.2s", opacity: post.done ? 0.6 : 1 }}
                onMouseOver={(e) => { e.currentTarget.style.background = C.cardHover; e.currentTarget.style.borderColor = primaryColor + "40"; }}
                onMouseOut={(e) => { e.currentTarget.style.background = C.card; e.currentTarget.style.borderColor = C.border; }}>
                ...
                <div style={{ width: 32, display: "flex", justifyContent: "center", flexShrink: 0 }}>
                  {post.status === "published" && post.postUrls && Object.keys(post.postUrls).length > 0 ? (
                    <button onClick={(e) => { e.stopPropagation(); const urls = Object.values(post.postUrls); urls.forEach((u) => window.open(u, "_blank")); }} title="Beitrag öffnen" style={{ width: 30, height: 30, borderRadius: 8, border: `1px solid ${C.yellow}30`, background: C.yellowGlow, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.2s" }}
