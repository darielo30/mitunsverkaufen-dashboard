...
import {
  ...
  LayoutDashboard, Bell, Settings, UserPlus, AlertCircle, XCircle
} from "lucide-react";
import {
  ...
  return (
    <div style={{ padding: "28px 32px", maxWidth: 800, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 16px", borderRadius: 10, background: C.yellowGlow, border: `1px solid ${C.yellow}30`, marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 12, color: C.yellow }}>Demo-Modus – Echte Benachrichtigungen werden angezeigt, sobald die Late API echte Interaktionsdaten liefert.</div>
      </div>

      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
        <div>
          <div style={{ fontSize: 22, fontWeight: 800, letterSpacing: "-0.02em" }}>Benachrichtigungen</div>
          <div style={{ fontSize: 13, color: C.muted, marginTop: 4 }}>{unread.length} ungelesen</div>
        </div>
        {unread.length > 0 && (
